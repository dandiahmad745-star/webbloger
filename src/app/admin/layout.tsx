...
import { Coffee, Settings, BookUser, Wrench, Home, Lock, Music, ClipboardList, Sparkles, Download } from 'lucide-react';
...
const menuItems = [
  ...
  { href: '/admin/template', label: 'Template', icon: Download },
