...
export default function PlaylistSayaPage() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center p-4 md:p-8 fade-in relative">
             {backgroundImage && (
                <Image
                ...
                <Card className="bg-card/30 backdrop-blur-lg border-primary/20 shadow-2xl shadow-primary/10 rounded-2xl overflow-hidden">
                    ...
                    <CardContent className="p-4 space-y-2">
                        {songs.length > 0 ? songs.map((song) => (
                            <div key={song.title} className="flex items-center p-3 bg-black/20 rounded-lg justify-between">
